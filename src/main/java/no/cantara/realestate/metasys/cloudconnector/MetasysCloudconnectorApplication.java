...
//        trendsIngestionService.addSubscriptions(sensorIds);
        ...
        if (enableStream && streamClient != null) {
            streamPocClient = new StreamPocClient(streamClient, sensorIdRepository, finalObservationDistributionClient, metricsDistributionClient, auditTrail);
    ...
    protected StreamPocClient wireMetasysStreamImporter(MetasysStreamClient streamClient, SensorIdRepository sensorIdRepository, ObservationDistributionClient distributionClient, MetasysMetricsDistributionClient metricsClient, AuditTrail auditTrail) {
        StreamPocClient streamPocClient = new StreamPocClient(streamClient, sensorIdRepository, distributionClient, metricsClient, auditTrail);
        try {
