 ...
 */
public class MetasysStreamClient implements BasClient {
    ...
    private static MetasysStreamClient instance;
     ...
     */
    private MetasysStreamClient(String username, String password, URI apiUri, NotificationService notificationService) {
     ...
     */
    public static synchronized MetasysStreamClient getInstance(String username, String password, URI apiUri, NotificationService notificationService) {
        if (instance == null) {
            instance = new MetasysStreamClient(username, password, apiUri, notificationService);
            instance.login();
        }
        return instance;
    }
     ...
     */
    public static synchronized MetasysStreamClient getInstance() {
        if (instance == null) {
...
//                e.printStackTrace();
    ...
    public static void main(String[] args) throws URISyntaxException, LogonFailedException {
        ...
        MetasysStreamClient apiClient = MetasysStreamClient.getInstance(username, password, apiUri, new SlackNotificationService());
